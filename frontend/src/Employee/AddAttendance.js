...
//send attendace data
    ...
    return(
      <div className="app" >
        ...
        <div class="col-md-6">
          <label for="pno" class="form-label">Hours Worked</label>
          <input type="text" class="form-control" id="workedhrs" pattern="[0-9]+" required placeholder="Worked Hours" onChange={(e)=>{
